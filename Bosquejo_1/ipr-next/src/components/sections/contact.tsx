    ...
    <section className="section section-contact" id="contacto" aria-label="Contacto">
      <div className="container" data-reveal-group>
        ...
        <div className="cta-row" data-reveal>
          <a className="btn btn--accent" href={WHATSAPP_LINK} target="_blank" rel="noreferrer" aria-label="Solicita tu cotización por WhatsApp">
            <span className="btn__text">Solicita tu cotización</span>
            <SplitText text="Solicita tu cotización" />
          </a>
          <a className="btn btn--ghost" href={INSTAGRAM_LINK} target="_blank" rel="noreferrer" aria-label="Ver Instagram de IPR Constructora">
        ...
        <div className="contact-social" data-reveal>
          <a className="social-btn" href={WHATSAPP_LINK} target="_blank" rel="noreferrer" aria-label="WhatsApp" title="WhatsApp">
          ...
          <a className="social-btn" href={INSTAGRAM_LINK} target="_blank" rel="noreferrer" aria-label="Instagram" title="Instagram">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
